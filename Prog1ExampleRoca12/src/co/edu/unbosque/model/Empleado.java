...
public class Empleado extends Persona implements Serializable{
	...
	public Empleado(String tipoContrato, int horasTrabajo) {
		super();
		this.tipoContrato = tipoContrato;
		this.horasTrabajo = horasTrabajo;
	}

	public Empleado(long cedula, String nombre, Date fechaNacimiento, String correo, String tipoContrato,
			int horasTrabajo) {
	...
	public Empleado(long cedula, String nombre, Date fechaNacimiento, String correo) {
		super(cedula, nombre, fechaNacimiento, correo);
	}
